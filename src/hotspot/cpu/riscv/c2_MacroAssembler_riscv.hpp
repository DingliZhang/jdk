...
// C2_MacroAssembler contains high-level macros for C2
 ...
 void unspill_vmask(VectorRegister v, int offset){
  ...
  void vfcvt_rtz_xu_f_v_safe(VectorRegister dst, VectorRegister src, VectorRegister tmp, VectorMask vm = Assembler::unmasked);
  void vfcvt_rtz_x_f_v_safe(VectorRegister dst, VectorRegister src, VectorRegister tmp, VectorMask vm = Assembler::unmasked);
  void vfwcvt_rtz_xu_f_v_safe(VectorRegister dst, VectorRegister src, VectorRegister tmp, VectorMask vm = Assembler::unmasked);
  void vfwcvt_rtz_x_f_v_safe(VectorRegister dst, VectorRegister src, VectorRegister tmp, VectorMask vm = Assembler::unmasked);
  void vfncvt_rtz_xu_f_w_safe(VectorRegister dst, VectorRegister src, VectorRegister tmp, VectorMask vm = Assembler::unmasked);
  void vfncvt_rtz_x_f_w_safe(VectorRegister dst, VectorRegister src, VectorRegister tmp, VectorMask vm = Assembler::unmasked);
